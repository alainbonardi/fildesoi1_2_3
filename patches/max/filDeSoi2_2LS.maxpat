...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 61.0, 544.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.401794000000052, 544.0, 54.0, 22.0 ],
					"text" : "mc.dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 246.75, 569.999996721744537, 159.098205999999891, 74.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 124.0, 212.0, 150.0, 47.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 154.0, -27.0, 47.0, 22.0 ],
									"text" : "ctlin #2"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 3.0, 3.5, 17.0, 101.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 3.0, 165.0, 39.0, 22.0 ],
									"text" : "$1 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 3.0, 191.0, 58.0, 22.0 ],
									"text" : "line -127."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 3.0, -27.0, 114.0, 22.0 ],
									"text" : "scale -127. 6. 0 127"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 3.0, -51.0, 81.0, 22.0 ],
									"text" : "loadmess #1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 3.0, 217.0, 60.0, 22.0 ],
									"text" : "gain $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 3.0, 133.0, 107.0, 22.0 ],
									"text" : "scale 0 127 -127 6"
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 1,
									"midpoints" : [ 163.5, -1.25, 12.5, -1.25 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 0 ],
									"hidden" : 1,
									"midpoints" : [ 124.5, -11.0, 68.5, -11.0, 68.5, -38.0, 12.5, -38.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 392.5, 505.499996721744537, 34.0, 18.0 ],
					"text" : "reset"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 123.901794000000052, 534.125, 70.5, 534.125 ],
					"order" : 1,
					"source" : [ "obj-12", 0 ]
				}
